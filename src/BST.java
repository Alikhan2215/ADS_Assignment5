...
public class BST<K extends Comparable<K>, V> {
    ...
    //Make it possible for both key and value to be accessible during the iteration
    ...
    //Perform in-order traversal and populate keyValues list with key-value pairs
